...
BOT_TOKEN = environ.get('BOT_TOKEN', '8239747249:AAED_EKaium8ye-YHqsYJmU3KeGu0-dIvic')
# Bot settings
...
auth_channel = environ.get('-1001681286512')
auth_grp = environ.get('-1002168048982')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ASMOVIE_DD:ASMOVIE_DD@cluster0.1riyjj1.mongodb.net/?appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Rajappan")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('-1003217849646',0))
